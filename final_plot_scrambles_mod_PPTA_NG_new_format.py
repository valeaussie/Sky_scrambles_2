...
with open('/fred/oz002/vdimarco/sky_scrambles/skies/results/2_final_PPTA_n_tries_many_mod.csv', 'r') as file:
...
plt.savefig('2_final_PPTA_NG_scrambles_mod.pdf', bbox_inches='tight' )
