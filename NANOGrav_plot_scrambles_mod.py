...
with open('/fred/oz002/vdimarco/sky_scrambles/skies/results/final_NANOGrav_n_tries_many_mod_2h.csv', 'r') as file:
...
plt.savefig('final_NANOGrav_mod.pdf', bbox_inches='tight' )
