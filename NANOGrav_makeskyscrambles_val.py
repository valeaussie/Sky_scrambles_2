...
n_a, n_i, c = get_scrambles(Omega, f, Pij, 10000, 0.17)

#print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/NANOGrav_thresh_0_17_67pulsars.csv', header=None, index=None) 
