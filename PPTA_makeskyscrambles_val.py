...
Omega_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/PPTA_Omega_alltimes.csv' 
f_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/PPTA_frequencies_alltimes.csv'
Pij_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/PPTA_S_I_alltimes.csv'
...
m, n_a, n_i, c = get_scrambles(orf_true[1], Omega, f, Pij, 30000, 0.1)

print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/2_final_PPTA_n_tries_many.csv', header=None, index=None) 
