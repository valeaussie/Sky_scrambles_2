...
raj_file = '/fred/oz002/vdimarco/IPTA_scrambles/results/IPTA_psr_rajd.txt'
dec_file = '/fred/oz002/vdimarco/IPTA_scrambles/results/IPTA_psr_dec.txt'
...
with open('/fred/oz002/vdimarco/IPTA_scrambles/results', mode = "w") as csv_file:
