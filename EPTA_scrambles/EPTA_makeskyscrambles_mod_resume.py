...
def get_scrambles(orf_true, Omega, f, Pij, N=10, thresh=0.1, resume=False):
    ...
    if resume == False:
        ...
        print("resume")
        orfs = list(np.load("/fred/oz002/vdimarco/EPTA_scrambles/results/EPTA_makeskyscrambles_orfs_mod.npy"))
        rejections = list(pd.read_csv("/fred/oz002/vdimarco/EPTA-scrambles/results/EPTA_n_tries_many_mod.csv", index_col=None).values.squeeze())
    ...
    while n_accep < N:
        ...
        if reject == False:
            ...
            np.save("/fred/oz002/vdimarco/EPTA_scrambles/results/EPTA_makeskyscrambles_orfs_mod", np.array(orfs))

            start = time.time()

            pd.DataFrame(rejections).to_csv('/fred/oz002/vdimarco/EPTA_scrambles/results/EPTA_n_tries_many_mod.csv', header=None, index=None)
            ...
            plt.savefig("/fred/oz002/vdimarco/EPTA_scrambles/plots/EPTA_nokill_mod.png")
            plt.clf()
...
#pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/EPTA_scrambles/results/EPTA_n_tries_many_mod.csv', header=None, index=None) 
