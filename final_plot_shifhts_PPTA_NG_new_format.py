...
with open('/fred/oz002/vdimarco/sky_scrambles/skies/results/final_PPTA_phase_shifts.csv', 'r') as file:
...
with open('/fred/oz002/vdimarco/sky_scrambles/skies/results/final_NANOGrav_phase_shifts.csv', 'r') as file:
    csvreader = csv.reader(file)
    n_t = []
    for row in csvreader:
        n_t.append(row)
