...
Omega_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/PPTA_DR3_Omega_alltimes.csv' 
f_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/PPTA_DR3_frequencies_alltimes.csv'
Pij_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/PPTA_DR3_S_I_alltimes.csv'
...
n_a, n_i, c = get_scrambles(orf_true, Omega, f, Pij, 1000, 0.1)

#print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/DR3_PPTA_n_tries_many_mod_2h.csv', header=None, index=None) 
