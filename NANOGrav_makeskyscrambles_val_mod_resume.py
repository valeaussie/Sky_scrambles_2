...
filename = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/12p5yr_stochastic_analysis/NANOGrav_ORF_true_12_5years.csv'
Omega_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/NANOGrav_Omega_45_psrs.csv' 
f_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/NANOGrav_frequencies_45_psrs.csv'
Pij_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/NANOGrav_S_I_45_psrs.csv'
...
def get_scrambles(orf_true, Omega, f, Pij, N=10, thresh=0.1, resume=False):
    ...
    if resume == False:
        ...
        print("resume")
        orfs = list(np.load("/fred/oz002/vdimarco/sky_scrambles/skies/results/NANOGrav_makeskyscrambles_val_orfs_mod.npy"))
        rejections = list(pd.read_csv("/fred/oz002/vdimarco/sky_scrambles/skies/results/2_final_NANOGrav_n_tries_many_mod.csv", index_col=None).values.squeeze())
    ...
    while n_accep < N:
        ...
        if reject == False:
            ...
            np.save("/fred/oz002/vdimarco/sky_scrambles/skies/results/NANOGrav_makeskyscrambles_val_orfs_mod", np.array(orfs))

            start = time.time()

            pd.DataFrame(rejections).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/2_final_NANOGrav_n_tries_many_mod.csv', header=None, index=None)
            ...
            plt.savefig("/fred/oz002/vdimarco/sky_scrambles/skies/plots/NANOGrav_nokill_mod.png")
            plt.clf()
...
#pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/NANOGrav_n_tries_many_2h.csv', header=None, index=None) 
